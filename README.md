...
Verify: visiting /.netlify/functions/ai-proxy should return {"error":"Method not allowed"} (function is live), and the Navigator should show a green "Personalized by LifeBridge" badge.
