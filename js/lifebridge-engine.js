...
/* ============================================================ demo scenario */
/* One carefully built example so the product can be understood without typing.
   The narrative is fictional and contains no real person's information.

   The hand-written plan below is a guaranteed fallback: if the live planner is
   unavailable, rate limited, or slow, the demo still shows the complete
...
window.LBEngine = {
  ...
  DEMO_SCENARIO, RESOURCE_CATALOG, resourcesForCrisis, fallbackPlan,
  RECOVERY_CEILING,
};
